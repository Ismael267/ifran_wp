...
class Woostify_Elementor_Product_Tab extends Widget_Base {
	...
	protected function render() {
		...
		$columns_tablet = isset( $list_first['col_tablet'] ) ? $list_first['col_tablet'] : $columns;
		$columns_mobile = isset( $list_first['col_mobile'] ) ? $list_first['col_mobile'] : $columns_tablet;
			...
			<div class="woostify-products-tab-body">
				...
				if ( ! empty( $list ) ) {
					foreach ( $list as $i => $j ) {
						...
						$cols_tablet = isset( $j['col_tablet'] ) ? $j['col_tablet'] : $cols;
						$cols_mobile = isset( $j['col_mobile'] ) ? $j['col_mobile'] : $cols_tablet;
						?>
