...
/**
 * Affiliates Creatives Post Table
 */
if ( !defined( 'ABSPATH' ) ) {
...
if ( !class_exists( 'FS_Affiliates_Creatives_Post_Table' ) ) {
    ...
    /**
     * FS_Affiliates_Creatives_Post_Table Class.
     * */
    class FS_Affiliates_Creatives_Post_Table extends WP_List_Table {
         ...
         * Post type
         * */
        private $post_type = 'fs-creatives' ;
        ...
        public function prepare_items() {
            $this->base_url = add_query_arg( array ( 'page' => 'fs_affiliates' , 'tab' => 'creatives' ) , admin_url( 'admin.php' ) ) ;
        ...
        public function get_columns() {
            $columns = array (
                ...
                'name'    => __( 'Creative Name' , FS_AFFILIATES_LOCALE ) ,
                'url'     => __( 'URL' , FS_AFFILIATES_LOCALE ) ,
                'status'  => __( 'Status' , FS_AFFILIATES_LOCALE ) ,
                'preview' => __( 'Preview' , FS_AFFILIATES_LOCALE ) ,
                    ) ;
        ...
        protected function column_default( $item , $column_name ) {
            ...
            switch ( $column_name ) {
                ...
                case 'status':
                    ...
                    break ;
                case 'preview':
                    return '<div class="fp_creative_preview_image"><img style="width:100px;height:auto;" src="' . $item->image . '"/></div>' ;
                    break ;
            }
        }
        ...
        private function prepare_item_object( $items ) {
            ...
            if ( fs_affiliates_check_is_array( $items ) ) {
                foreach ( $items as $item ) {
                    $prepare_items[] = new FS_Affiliates_Creatives( $item[ 'ID' ] ) ;
                }
            }
            ...
            if ( isset( $_REQUEST[ 's' ] ) ) {
                ...
                foreach ( $terms as $term ) {
                    ...
                    if ( isset( $_GET[ 'post_status' ] ) && $_GET[ 'post_status' ] != 'all' ) {
                        ...
                        $post_status_array = array ( 'fs_active' , 'fs_inactive' ) ;
