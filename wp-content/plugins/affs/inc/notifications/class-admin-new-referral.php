...
/**
 * Admin - Affiliate New Referral
 */
if ( !defined( 'ABSPATH' ) ) {
    exit ; // Exit if accessed directly.
}

if ( !class_exists( 'FS_Affiliates_Admin_New_Referral' ) ) {

    /**
     * Class FS_Affiliates_Admin_New_Referral
     */
    class FS_Affiliates_Admin_New_Referral extends FS_Affiliates_Notifications {

        /**
         * Class Constructor
         */
        public function __construct() {
            $this->id    = 'admin_new_referral' ;
            $this->title = __( 'Admin - Affiliate New Referral' , FS_AFFILIATES_LOCALE ) ;
        ...
        public function trigger( $referral_id , $referral = false ) {
            ...
            if ( is_a( $referral , 'FS_Affiliates_Referrals' ) ) {
                ...
                $this->placeholders[ '{referral_amount}' ]      = $referral->amount ;
            }
        ...
        public function settings_options_array() {
            ...
            $settings[] = array (
                'title'   => __( 'Send New Referral Email to Admin' , FS_AFFILIATES_LOCALE ) ,
            ...
            if ( $this->sms_module_enabled() ) {
                ...
                $settings[] = array (
                    'title'   => __( 'Send New Referral SMS to Admin' , FS_AFFILIATES_LOCALE ) ,
