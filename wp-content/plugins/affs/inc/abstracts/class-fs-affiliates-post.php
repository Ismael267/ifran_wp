...
if ( ! class_exists( 'FS_Affiliates_Post' ) ) {

    /**
     * FS_Affiliates_Post Class.
     */
    abstract class FS_Affiliates_Post {
        ...
        public function exists() {
            ...
            return $this->post->post_type == $this->post_type ;
        }
        ...
        protected function load_metadata() {
            ...
            if ( ! fs_affiliates_check_is_array( $meta_data_array ) )
        ...
        public function create( $meta_data , $post_args = array() ) {
            ...
            if ( ! apply_filters( 'fs_affiliates_create_new_referral' , true , null , (isset( $post_args[ 'post_author' ] ) ? $post_args[ 'post_author' ] : 0 ) ) )
                return 0 ;
        ...
        public function update_metas( $meta_data ) {
            ...
            foreach ( $this->meta_data_keys as $meta_key => $default ) {
                ...
                update_post_meta( $this->id , $meta_key , $meta_data[ $meta_key ] ) ;
            }
        }
